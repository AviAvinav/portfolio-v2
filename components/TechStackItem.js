...
const TechStackItem = ({ Icon, text, desc, href }) => {
  return (
    <div className="flex flex-col items-center text-center space-y-2 relative group cursor-pointer">
      ...
      <div className="absolute hidden xl:flex flex-col opacity-0 rounded max-h-60 min-h-[8rem] bg-gray-600 dark:bg-gray-900 backdrop-blur-3xl group-hover:opacity-90 dark:group-hover:opacity-95 text-left py-3 px-4 space-y-0.5 transition ease-out duration-500 -right-40 -top-3 z-40">
